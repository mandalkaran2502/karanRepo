...
void handleCreateAccount(BankManager* bank) 
{
    ...
    if (std::cin.fail()) 
    {
        std::cin.clear();
        std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
        std::cout << "Entered Invalid amount!" << std::endl;
        return;
    }
...
void handleLogin(BankManager* bank) 
{
    ...
    if (std::cin.fail())
    {
        std::cin.clear();
        std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
        std::cout << "Entered Invalid account number!" << std::endl;
        return;
    }
        ...
        switch (choice) 
        {
            ...
            case 6: 
            {
                ...
                if (std::cin.fail()) 
                {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Entered Invalid tenure!" << std::endl;
                } 
                else 
                {
            ...
            case 8:
                ...
                break;
            default:
                std::cout << "Entered Invalid choice! Please try again." << std::endl;
                pause();
        }
    }
}
